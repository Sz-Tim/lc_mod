...
```
## [1] "106 of 800 iterations saturated the maximum tree depth of 10 (13.25%)"
## [1] "Run again with max_depth set to a larger value to avoid saturation"
```

```
## [1] "0 of 800 iterations ended with a divergence (0%)"
```
...
```
##          warmup   sample
## chain:1 77713.1  48802.9
## chain:2 70850.8 123393.0
## chain:3 82029.2  35250.6
## chain:4 91266.0 279508.0
```
...
##  1 Y1+Y2     1    0.027   0.053 -0.026 -0.491
##  2 Y1+Y2     2    0.036   0.084 -0.048 -0.571
##  3 Y1+Y2     3    0.062   0.210 -0.148 -0.705
##  4 Y1+Y2     4    0.103   0.187 -0.084 -0.449
##  5 Y1+Y2     6    0.042   0.213 -0.171 -0.803
##  6    Y2     1    0.090   0.093 -0.003 -0.032
##  7    Y2     2    0.105   0.114 -0.009 -0.079
##  8    Y2     3    0.149   0.154 -0.005 -0.032
##  9    Y2     4    0.102   0.184 -0.082 -0.446
## 10    Y2     6    0.185   0.185  0.000  0.000
```
...
## 1 beta_p[1] 0.536 0.698 0.794 0.877 1.052
## 2 beta_p[2] 2.277 2.482 2.586 2.707 2.992
## 3 beta_p[3] 0.116 0.196 0.238 0.280 0.366
```
