...
out <- stan(file="code/LC_mod_Y2X_phi.stan", init=0, thin=25,
            data=read_rdump("code/LC_mod_examp.Rdump"), 
            iter=20000, warmup=1000, chains=8, seed=4337, refresh=1000,
...
```
## [1] "0 of 6080 iterations saturated the maximum tree depth of 10 (0%)"
```

```
## [1] "0 of 6080 iterations ended with a divergence (0%)"
```
...
```
## [1] 96520 96520 96520 96520 96520 96520 96520 96520
```
...
##  4 Y1+Y2     4    0.094   0.203 -0.109 -0.537
##  5 Y1+Y2     6    0.033   0.210 -0.177 -0.843
##  6    Y2     1    0.050   0.073 -0.023 -0.315
...
##  3  beta_d[3] -0.026 -0.020 -0.016 -0.013 -0.007
##  4  beta_d[4] -0.027 -0.023 -0.021 -0.019 -0.015
##  5  beta_d[5] -0.014 -0.009 -0.006 -0.003  0.002
##  6  beta_d[6] -0.013 -0.004  0.001  0.007  0.017
##  7  beta_d[7] -0.209 -0.176 -0.158 -0.141 -0.110
##  8  beta_d[8] -0.009  0.000  0.004  0.009  0.017
##  9  beta_d[9] -0.136 -0.108 -0.094 -0.080 -0.053
## 10 beta_d[10] -0.065 -0.046 -0.037 -0.027 -0.007
## 11 beta_d[11] -0.031 -0.015 -0.007  0.001  0.015
## 12 beta_d[12] -0.008 -0.001  0.002  0.006  0.012
## 13  beta_p[1]  0.020  0.080  0.114  0.146  0.205
## 14  beta_p[2]  0.409  0.510  0.566  0.620  0.728
## 15  beta_p[3]  0.126  0.205  0.247  0.291  0.375
## 16  beta_p[4] -0.281 -0.227 -0.199 -0.172 -0.120
```
