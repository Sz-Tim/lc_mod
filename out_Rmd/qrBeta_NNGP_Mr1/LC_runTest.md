transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 10. See
...
```
## [1] "199 of 400 iterations saturated the maximum tree depth of 10 (49.75%)"
## [1] "Run again with max_depth set to a larger value to avoid saturation"
```

```
## [1] "Chain 1: E-BFMI = 0.104080516346956"
## [1] "E-BFMI below 0.2 indicates you may need to reparameterize your model"
## [1] "Chain 2: E-BFMI = 0.163675265867612"
## [1] "E-BFMI below 0.2 indicates you may need to reparameterize your model"
```

```
## [1] "3 of 400 iterations ended with a divergence (0.75%)"
...
```
## [1] 37492 36302 46542 42958 33742 45006 30158 42446
```
...
```
##          warmup  sample
## chain:1 24685.6 23660.1
## chain:2 22568.8 23037.2
## chain:3 22983.1 27082.3
## chain:4 23051.3 26049.9
## chain:5 26367.8 21301.8
## chain:6 24920.3 25717.3
## chain:7 23427.5 20104.1
## chain:8 22892.0 25622.4
```
...
##  1 Y1+Y2     1    0.023   0.065 -0.042 -0.646
##  2 Y1+Y2     2    0.036   0.093 -0.057 -0.613
##  3 Y1+Y2     3    0.088   0.198 -0.110 -0.556
##  4 Y1+Y2     4    0.099   0.179 -0.080 -0.447
##  5 Y1+Y2     6    0.073   0.206 -0.133 -0.646
##  6    Y2     1    0.087   0.084  0.003  0.036
##  7    Y2     2    0.109   0.120 -0.011 -0.092
##  8    Y2     3    0.159   0.166 -0.007 -0.042
##  9    Y2     4    0.106   0.230 -0.124 -0.539
## 10    Y2     6    0.220   0.219  0.001  0.005
```
...
##  1  beta_d[1]  0.013  0.015  0.016  0.018  0.020
##  2  beta_d[2]  0.000  0.002  0.004  0.005  0.008
##  3  beta_d[3] -0.017 -0.011 -0.007 -0.004  0.001
##  4  beta_d[4] -0.029 -0.025 -0.023 -0.021 -0.018
##  5  beta_d[5] -0.015 -0.011 -0.008 -0.006 -0.001
##  6  beta_d[6] -0.002  0.010  0.018  0.025  0.038
##  7  beta_d[7] -0.253 -0.216 -0.195 -0.176 -0.145
##  8  beta_d[8] -0.011 -0.004  0.000  0.004  0.011
##  9  beta_d[9] -0.144 -0.118 -0.103 -0.089 -0.067
## 10 beta_d[10] -0.067 -0.050 -0.041 -0.032 -0.015
## 11 beta_d[11]  0.000  0.016  0.023  0.032  0.051
## 12 beta_d[12] -0.004  0.000  0.003  0.005  0.009
## 13  beta_p[1]  0.416  0.529  0.598  0.656  0.766
## 14  beta_p[2]  1.094  1.224  1.292  1.363  1.474
## 15  beta_p[3] -0.038  0.026  0.065  0.093  0.157
```
