...
out <- stan(file="code/LC_mod_Y2X_SpatOnly.stan", init=0, thin=25,
            data=read_rdump("code/LC_mod_examp.Rdump"), 
            iter=5000, warmup=2000, chains=4, seed=4337, refresh=100,
...
```
## [1] "0 of 480 iterations saturated the maximum tree depth of 10 (0%)"
```

```
## [1] "20 of 480 iterations ended with a divergence (4.16666666666667%)"
...
```
##          warmup  sample
## chain:1 32378.5 42183.6
## chain:2 34989.2 41182.9
## chain:3 32587.7 41085.2
## chain:4 33367.5 71009.5
```
...
##  1 Y1+Y2     1    0.032   0.053 -0.021 -0.396
##  2 Y1+Y2     2    0.068   0.084 -0.016 -0.190
##  3 Y1+Y2     3    0.126   0.210 -0.084 -0.400
##  4 Y1+Y2     4    0.095   0.187 -0.092 -0.492
##  5 Y1+Y2     6    0.092   0.213 -0.121 -0.568
##  6    Y2     1    0.079   0.093 -0.014 -0.151
##  7    Y2     2    0.108   0.114 -0.006 -0.053
##  8    Y2     3    0.176   0.154  0.022  0.143
##  9    Y2     4    0.094   0.184 -0.090 -0.489
## 10    Y2     6    0.191   0.185  0.006  0.032
```
...
## 1 beta_p[1] 0.585 0.706 0.788 0.882 1.026
## 2 beta_p[2] 2.129 2.312 2.405 2.501 2.719
## 3 beta_p[3] 0.215 0.277 0.318 0.351 0.426
```
