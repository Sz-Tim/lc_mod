...
time.ls <- vector("list", length=3) %>% list() %>% rep(nrow(time.df))
...
out <- stan(file="mod_sandbox/veg_SB1_6-3_vectorized.stan", data=d_SB1, thin=50,
            init=0, chains=1, seed=874)#,
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
mod.time.2 <- system.time({
out2 <- stan(file="mod_sandbox/veg_SB1_6-3_vectorized_2.stan", data=d_SB1, thin=50,
            init=0, chains=1, seed=874)#, 
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
mod.time.3 <- system.time({
out3 <- stan(file="mod_sandbox/veg_SB1_6-3_vectorized_3.stan", data=d_SB1, thin=50,
            init=0, chains=1, seed=874)#, 
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
