...
out2 <- stan(file="mod_sandbox/veg_SB1_6-3.stan", data=d_SB1, thin=50, init=0)


# visualize
## nu
gg.nu <- ggs(out2, "n_eta") %>% arrange(Parameter, Chain, Iteration)
nGG <- attr(gg.nu, "nChains")*attr(gg.nu, "nIterations")
...
## betas
gg.b <- ggs(out2, "beta") %>% arrange(Parameter, Chain, Iteration)
