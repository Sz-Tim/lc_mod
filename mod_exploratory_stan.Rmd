...
```{r veg_SB1_6}
time.df <- tibble(n=c(500))#, 1000, 1000, 2000, 5000, 10000))
time.ls <- vector("list", length=3) 
names(time.ls) <- c("cauch0_Lmx0", "cauch0_Lmx1",
                    "cauch1_Lmx0")
...
out <- stan(file="mod_sandbox/6-3_cauch0_Lmx0.stan",
            data=d_SB1, thin=50, init=0, chains=2, seed=334561)#,
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
mod.time.2 <- system.time({
out2 <- stan(file="mod_sandbox/6-3_cauch0_Lmx1.stan",
             data=d_SB1, thin=50, init=0, chains=2, seed=334561)#,
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
