...
```{r veg_SB1_6}
time.df <- tibble(n=c(5, 25, 50, 100, 500))#, 1000, 2000, 5000))
time.ls <- vector("list", length=4) %>% list() %>% rep(nrow(time.df))
...
out <- stan(file="mod_sandbox/veg_SB1_6-3_repar_inline.stan", data=d_SB1, thin=50,
            init=0, chains=1, seed=874)#,
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
mod.time.2 <- system.time({
out2 <- stan(file="mod_sandbox/veg_SB1_6-3_cauch_inline.stan", data=d_SB1, thin=50,
            init=0, chains=1, seed=874)#, 
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
mod.time.3 <- system.time({
out3 <- stan(file="mod_sandbox/veg_SB1_6-3_repar_sep.stan", data=d_SB1, thin=50,
            init=0, chains=1, seed=874)#, 
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
mod.time.4 <- system.time({
out4 <- stan(file="mod_sandbox/veg_SB1_6-3_cauch_sep.stan", data=d_SB1, thin=50,
            init=0, chains=1, seed=874)#, 
            # control=list(adapt_delta=0.95, max_treedepth=15))
})
