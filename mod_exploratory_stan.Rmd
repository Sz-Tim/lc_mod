...
out <- stan(file="mod_sandbox/veg_SB1_6-3.stan", data=d_SB1, thin=50, init=0,
            chains=3, control=list(adapt_delta=0.95, max_treedepth=15), seed=1337)
})
mod.time.2 <- system.time({
out2 <- stan(file="mod_sandbox/veg_SB1_6-3_noSamples.stan", data=d_SB1, thin=50, init=0,
            chains=3, control=list(adapt_delta=0.95, max_treedepth=15), seed=1337)
})
time.df$m1[time.df$n==nCell] <- mod.time.1[3]
time.df$m2[time.df$n==nCell] <- mod.time.2[3]
