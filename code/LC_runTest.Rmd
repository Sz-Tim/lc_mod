...
out <- stan(file="code/sc_theta/direct.stan", init=0, thin=20,
...
ggsave("out/LC_direct.jpg", sc.p, height=10, width=25)
...
ggsave("out/comp_direct.jpg", c.p, height=10, width=25)
...
ggsave("out/sp_resid_direct.jpg", sp.resid, height=5, width=25)
