...
maxGridRow <- 4  # number of blocks per row; 1-40
maxGridCol <- 4  # number of blocks per column; 1-54
...
d <- list(n1=nFit, n2=nFit+1, n3=n$tot, L=6, nB_d=nBd, nB_p=nBp,
          ...
          M=(1+2*M_r)^2-1, nn_id=t(nn_id), nn_d=nn_d, nn_dM=t(nn_dM),
...
out <- stan(file="code/direct_SpOnly_cNNGP.stan", init=0, thin=5,
            data=read_rdump("code/all_data.Rdump"), 
            iter=200, warmup=100, chains=1, seed=4337, refresh=10,
