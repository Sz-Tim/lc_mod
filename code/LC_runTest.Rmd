...
out <- stan(file="code/LC_mod_Y2X_GPP.stan", init=0, thin=25,
            ...
            iter=2000, warmup=1000, chains=4, seed=4337, refresh=10,
            include=FALSE, pars=c("Y2_ds", "e_z", "w_z", "w", "w_star",
...
ggplot(gg.med, aes(x=BlockCol, y=BlockRow)) + 
  ...
  geom_point(data=coords_star, aes(y=b.cols, x=b.rows), shape=1)
