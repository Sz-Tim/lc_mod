...
library(forcats); library(rstan); library(ggmcmc); library(stringr)
...
```{r spatialSetup, fig.width=5, fig.height=5}
...
out <- stan(file="code/LC_mod_Y2X.stan", init=0, thin=25,
            ...
            iter=20000, warmup=10000, chains=4, seed=4337, refresh=100,
