...
out <- stan(file="code/LC_mod_uvBeta.stan", data=d, init=0, thin=50, 
            iter=1000, warmup=700, chains=4, seed=4337, refresh=500,
            include=FALSE, pars="Y2_ds", "nu",
            control=list(max_treedepth=20, adapt_delta=0.95, metric="diag_e"))
```
