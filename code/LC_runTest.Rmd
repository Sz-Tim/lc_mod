...
out <- stan(file="code/LC_mod_qr_d.stan", data=d, init=0, thin=50, 
            iter=5000, warmup=2000, chains=2, seed=4337, refresh=500,
...
samp.out <- cbind(energies[,c(1,6)], extract(out, pars="lp__")[[1]], 
                  extract(out, pars="L_sigma_unif")[[1]][,1,],
                  extract(out, pars="L_sigma_unif")[[1]][,2,])
colnames(samp.out) <- c("accept_stat__", "energy__", "lp__", 
                        "L_sig[1,1]", "L_sig[1,2]", "L_sig[1,3]", 
                        "L_sig[1,4]", "L_sig[1,5]", 
                        "L_sig[2,1]", "L_sig[2,2]", "L_sig[2,3]", 
                        "L_sig[2,4]", "L_sig[2,5]")
