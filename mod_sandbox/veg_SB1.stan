data {
  ...
  matrix[N,nB_d[4]] X_d4;  //bias covariates: Mxd
  matrix[N,nB_d[5]] X_d5;  //bias covariates: Evg
}
parameters {
  ...
  vector[nB_d[4]] beta_d4;  //bias betas: Mxd
  vector[nB_d[5]] beta_d5;  //bias betas: Evg
}
